                    ...
                    try
                    {
                        ...
                        using(SqlCommand checkUsern = new SqlCommand(selectUsern, connect))
                        {
                            ...
                            else
                            {
                                ...
                                string relativePath = Path.Combine(@"D:\Cafe-shop\CafeShopManagementSystemCSharp\CafeShopManagementSystem\CafeShopManagementSystem\User_Directory\", adminAddUsers_username.Text.Trim() + ".jpg");
