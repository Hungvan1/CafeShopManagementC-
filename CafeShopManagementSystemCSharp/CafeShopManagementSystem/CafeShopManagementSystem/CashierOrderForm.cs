...
namespace CafeShopManagementSystem
{
    public partial class CashierOrderForm : UserControl
    {
        ...
        SqlConnection connect = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\trinh\OneDrive\Documents\Cafe.mdf;Integrated Security=True;Connect Timeout=30");
        ...
        {
            using (SqlConnection connect = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\trinh\OneDrive\Documents\Cafe.mdf;Integrated Security=True;Connect Timeout=30"))
            {
                connect.Open();
